...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        pokemon_action = QAction(
            "Pokemons", self
        )  # Crear una acción dentro del menú "Archivo"
        ...
        pokemon_action.setIcon(
            QIcon("./examples/PyQt6/pokebola.png")
        )  # Icono de la acción

        teams_action = QAction(
            "Teams", self
        )  # Crear una acción dentro del menú "Archivo"
        ...
        self.background = QPixmap("./examples/PyQt6/background.png")
